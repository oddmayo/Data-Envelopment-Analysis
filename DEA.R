...
# para que se sospeche de un dato atípico, la distancia entre el punto ubicado en cero y la línea punteada tiene que ser muy grande
...
eft_circj_ordenada <- eft_circj[order(-eft_circj$Eficiencia_técnica),] # ordenar por eficiencia
eft_circj_ordenada
...
recomen1_ordenada <- recomen1[order(-eft_circj$Eficiencia_técnica),]
recomen1_ordenada
...
# para que se sospeche de un atípico, la distancia entre el punto ubicado en cero y la línea punteada tiene que ser muy grande
...
eft_distj
eft_distj_ordenada <- eft_distj[order(-eft_distj$Eficiencia_técnica),] #ordenar por eficiencia
eft_distj_ordenada
# unidades de REFERENCIA
dea2$lambda
# HOLGURAS (eficiencia fuerte o débil)
...
eft_distt
eft_distt_ordenada <- eft_distt[order(-eft_distt$Eficiencia_técnica),] #ordenar por eficiencia
eft_distt_ordenada
# unidades de REFERENCIA
...
# COMPARACIÓN entre primera y segunda instancia
...
##########################
library(xlsx)
write.xlsx(eft_circj_ordenada,"C:/Users/CamiloAndrés/Desktop/basejc_ordenada.xlsx")
write.xlsx(eft_distj_ordenada,"C:/Users/CamiloAndrés/Desktop/basejd_ordenada.xlsx")
write.xlsx(eft_distt_ordenada,"C:/Users/CamiloAndrés/Desktop/basetd_ordenada.xlsx")
write.xlsx(recomen1_ordenada,"C:/Users/CamiloAndrés/Desktop/recomen1_ordenada.xlsx")
write.xlsx(superef1_ordenada,"C:/Users/CamiloAndrés/Desktop/superef1_ordenada.xlsx")
...
tablalabelf1$color[which(tablalabelf1$eficiencia==1)]=rep("slateblue4", 5) #número de unidades eficientes
...
tablalabelf3$color[which(tablalabelf3$eficiencia==1)]=rep("slateblue4",3) #número de unidades eficientes
